...
export class MenuLitElement extends LitElement {
  ...
  constructor() {
    ...
    angular-assembly  
      ...
      fire event/communicate close menu        
  ...
  render() {
    ...
    return html`
      ...
      <div class="container">        
        ...
        <ul class="rootMenu">
          ${this.rootMenu.map((item) => rootMenuItem(item))}
        </ul>

        ${this.menu
        ? html` 
          <table class="menu">
            <tbody>${this.menu.map((item) => menuItem(item))}</tbody>
          </table>`
        : html``}
        ...
        ? html` 
          <table class="subMenu">
            <tbody>${this.subMenu.map((item) => menuItem(item))}</tbody>
          </table>`
        : html``}
      </div>
    `;
